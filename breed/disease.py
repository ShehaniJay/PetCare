...
def generate_pdf_report(
    ...
    elements.append(Paragraph(
        "⚠️ Disclaimer: This report is generated using an AI prediction model. "
        "Please consult a qualified veterinarian for an accurate diagnosis and treatment.",
        styles['Normal']
    ))
...
st.download_button(
    ...
    data=pdf,
    file_name="pet_disease_report.pdf",
